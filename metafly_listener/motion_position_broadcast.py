...
class Localizer():
    ...
    def begin_process(self):
        ...
        # self.optionsDict["clientAddress"] = "192.168.18.123"#"192.168.18.158" #This is my computer as a client
        ...
        # self.optionsDict["serverAddress"] = "192.168.18.189"#"192.168.18.189"
    ...
    def classifier_behavior(self):
        ...
        port = 54321
        # ip = "192.168.18.189" #Ip of SERVER that is broadcasting data over whatever network you choose (i.e., NUMSR)
        # ip = "10.42.0.101" #Ip of SERVER that is broadcasting data over whatever network you choose (i.e., TurtleBotRouter)
        ip = "192.168.1.3" #Ip of SERVER that is broadcasting data over whatever network you choose (i.e., Wired connection)
        # ip = "0.0.0.0"
            ...
            while self.is_looping:
                ...
                if len(all_pos) > 0:
                    ...
                    if len(encoded_message) > 1024:
                        print('message length exceeded maximum!!')
                        # while True:
                        #     time.sleep(2)
