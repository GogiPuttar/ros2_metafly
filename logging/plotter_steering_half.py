...
for steering_command in unique_steering_commands:
    ...
    plt.scatter([steering_command] * len(radii), 1 / radii, color='blue', label='1/Turning Radius')
...
for steering_command in unique_steering_commands:
    ...
    # Scatter plot the data points
    plt.scatter([steering_command] * len(pitch_values), pitch_values, color='red', label='Pitch')
